...
int main()
{
    ...
    window wind = open_window("Display Setup", 800, 600);
    ...
    for (int i = 0; i < disp_count; i++)
    {
        ...
        draw_text_on_window(wind, display_resolution_string, COLOR_BLACK, font, 10, origin_x + 5, origin_y + 50);
        refresh_screen();
    }
