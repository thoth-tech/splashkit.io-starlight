...
| Link                                             | Description                                                                                       |
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| [Issue_1](/troubleshoot/windows-wsl/wsl-issue-1) | Issues creating Ubuntu (WSL) user account. |
| [Issue_2](/troubleshoot/windows-wsl/wsl-issue-2) | `Exception has occurred: CLR/System.StackOverflowException` when trying to open GUI applications. |
