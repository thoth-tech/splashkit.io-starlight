...
point_x = -30
movement_speed = 2
demo_window = open_window("Moving Point Boundary Check", window_width, 500)
...
while not quit_requested():
    ...
    test_point = point_at(point_x, 300)
    point_is_inside = point_in_window(demo_window, test_point)
