...
if sprite_bitmap_collision_with_cell_at_point(sk_sprite, file_bmp, 20, file_bmp_loc):
    write_line("SplashKit got a new file!")

if sprite_bitmap_collision_with_cell_at_point(sk_sprite, file_bmp, 200, bug_bmp_loc):
