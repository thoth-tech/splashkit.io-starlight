...
:::note
These examples use functions such as [Load Resources Bundle](/api/resource-bundles/#load-resources-bundle) and [Free Resource Bundle](/api/resource-bundles/#free-resource-bundle).

To test the code below you can download these [**Resources**](/resources/guides/resource-bundles/basics/BasicBitmapResources.zip).
:::
