...
TODO: Add very brief introduction to matrix-based Hill Cipher.
...
TODO: Add somewhat compacted/concise version of your introduction to the Hill Cipher. This part can include some of the details such as the maths behind it, or can be more general, with the maths in the sections below.

### Encoding with the Hill Cipher

TODO: Add explanation and code for a function named "hill_cipher_encode" (can just be C++ code). And any related functions.

:::note[Using this function]

TODO: add example code using hill_cipher_encode

:::

:::tip[Expected Output]

TODO: Add expected output (similar to above).
...
TODO: add example code using hill_cipher_decode
