...
<Aside type="caution" title="Checkpoint!">
  We recommend you first familiarise yourself with the [Resolving Collisions
  Using Vectors](/guides/physics/4-collision-detection-using-vectors/) tutorial
  before proceeding with this one. This will provide you with a solid
  understanding of the fundamental principles of collision detection and how to
  effectively make use of the SplashKit physics functions.
</Aside>
