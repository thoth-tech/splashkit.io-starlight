...
import soundEffectsCode_withSK from '/public/beyond-splashkit/code-files/audio/0-sound-effects/with-splashkit.cpp?raw';
import soundEffectsCode_noSK from '/public/beyond-splashkit/code-files/audio/0-sound-effects/no-splashkit.cpp?raw';
...
```shell
g++ program.cpp -o run_program -l SplashKit
```
...
When compiling without SplashKit, you will need to include more compiler flags.
...
To test the code below, you can download these [**Resources**](/beyond-splashkit/resources/BeyondSplashKit_SoundEffects_Resources.zip).
