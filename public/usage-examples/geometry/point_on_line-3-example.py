...
main_window = open_window("Point On Line Example", 800, 600)

# Define a horizontal line from point (100, 300) to (700, 300)
line_base = line_from(100, 300, 700, 300)
...
while not window_close_requested(main_window):
    ...
    # Draw the black line
    draw_line_record(color_black(), line_base)

    # Get current mouse position
    mouse_pos = mouse_position()

    # Manually check proximity to the hidden point with margin
    ...
    if point_found:
        ...
        draw_text_no_font_no_size(
            "Move your mouse over the line to find the hidden point!", color_black(), 150, 450
        )
