...
while (not quit_requested()):
    ...
    if button_at_position("Click to invert Y axis", rectangle_from(320, 450, 160, 30)) and flipped == False:
        opacity_value = 0
        displayed_text = "This bitmap has been flipped along its Y axis"
        flipped = True
    elif button_at_position("Click to invert Y axis", rectangle_from(320, 450, 160, 30)) and flipped == True:
        opacity_value = 0
        displayed_text = "This bitmap is not flipped along its Y axis"
        flipped = False
