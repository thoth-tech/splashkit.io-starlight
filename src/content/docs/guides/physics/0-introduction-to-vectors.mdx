...
category: Guides
authors: Aditya Parma, Shaun Ratcliff
lastupdated: 15 Aug 24
---
...
1. [Vector To String](https://splashkit.io/api/physics/#vector-to-string)
2. [Vector Point to Point](https://splashkit.io/api/physics/#vector-point-to-point)

## Contents

- [SplashKit Vectors](#what-is-a-vector)
- [SplashKit Coordinates](#splashkit-coordinates)
- [What is a Vector?](#what-is-a-vector)
- [Where and When to Use Vectors](#where-and-when-to-use-vectors)
- [Vector Usage in Programming](#vector-usage-in-programming)
- [Visualising Vectors](#visualising-vectors)
- [Creating Vectors from Points](#creating-vectors-from-points)
...
![SplashKit Axis](./images/splashkit-axis.png)
...
To visualise vectors, we will create a simple program using SplashKit to draw vectors on a Cartesian plane. We will use the `vector_to_string` function to convert the vector into a human-readable format.
...
- **`vector_2d`** is a structure provided by SplashKit that holds two values, x and y, representing the vector's coordinates in 2D space.
...
<Tabs syncKey="code-language">
  <TabItem label="C++">
  ```cpp 
  vector_to_string(my_vector); 
  ```
  </TabItem>

  <TabItem label="C#">
  ```csharp 
  SplashKit.VectorToString(myVector) 
  ```
  </TabItem>
</Tabs>
...
![Introduction to Vectors](./images/introduction-to-vectors-1.PNG)
...
var window = SplashKit.OpenWindow("Introduction to Vectors", 800, 600);
...
![Vector Point to Point](./images/vector-point-to-point.png)
