...
namespace DisplayDetailsExample2
{
    public class Program
    {
        public static void Main()
        {
            ...
            Window wind = SplashKit.OpenWindow("Display setup", 800, 600);
            ...
            for (int i = 0; i < dispCount; i++)
            {
                ...
                wind.DrawText(displayResolutionString, Color.Black, font, 10, originX + 5, originY + 50);
                wind.Refresh();
            }
