...
If you choose not to use the automated setup on the previous page or are experiencing issues, you can follow these steps below:
...
![GIF showing skm installation in Terminal](./src/assets/gifs/setup-linux/SkmLinuxInstall.gif)
