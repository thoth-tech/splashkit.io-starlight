...
namespace DrawingUsingProcedures
{
    public class Program
    {
        ...
        {
            // Open a window with the specified title, width, and height
            Window window = SplashKit.OpenWindow("Window Title... to change", 800, 600);
...
using static SplashKitSDK.SplashKit;
  ...
  // Delay for 5 seconds to view the drawing
  Delay(5000);
...
namespace DrawingUsingProcedures
{
    public class Program
    {
        public static void Main()
        {
            ...
            Window window = SplashKit.OpenWindow("Shapes by ...", 800, 600);
