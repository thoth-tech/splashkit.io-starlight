...
- **_Zip file_** (_only if your code requires resource files_) containing the "Resources" folder created with the `skm resources` command, with any resources needed for your example code to run. (More info about adding this at the end.)
...
Here is an example of files for one of the code examples added for the `write_line` function that are demonstrating the use of `void write_line(string line);`:
