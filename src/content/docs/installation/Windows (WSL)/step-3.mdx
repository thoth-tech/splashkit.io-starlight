...
[Visual Studio Code](https://code.visualstudio.com/) is a versatile, user-friendly source code editor that supports extensions for multiple languages, including C#, C++ and python. Follow these steps to install Visual Studio Code on WSL and set up the necessary extensions.
...
![Adding WSL extension in Visual Studio Code](/images/installation/WSL-in-vscode.png)
