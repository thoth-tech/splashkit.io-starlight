...
<TabItem label="C++">
  ...
  namespace GameDataManagement
  {
      ...
      {
          private Json _gameData;

          public GameDataHandler(string filePath)
          {
              _gameData = SplashKit.JsonFromFile(filePath);
          }

          public string GetGameTitle()
          {
              if (SplashKit.JsonHasKey(_gameData, "gameTitle"))
              {
                  return SplashKit.JsonReadString(_gameData, "gameTitle");
              }
              else
              {
                  return "Key \"gameTitle\" not found.";
              }
          }
  
          public void FreeGameData()
          {
              SplashKit.FreeJson(_gameData);
          }
      }
      ...
      public class Program
      {
          ...
          {
              GameDataHandler gameDataHandler = new GameDataHandler("game_data.json");

              string gameTitle = gameDataHandler.GetGameTitle();
              SplashKit.WriteLine("Game Title: " + gameTitle);

              gameDataHandler.FreeGameData();
          }
      }
  }
...
namespace GameDataManagement
{
    public class Program
    {
        ...
        public static void Main()
        {
            Program gameDataHandler = new Program("game_data.json");

            string gameTitleMessage = gameDataHandler.GetGameTitle();
            SplashKit.WriteLine(gameTitleMessage);
