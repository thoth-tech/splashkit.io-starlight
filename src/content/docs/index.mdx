...
import GameCardSwiper from '../../components/react/GameCardSwiper/GameCardSwiper.jsx';
...
The Games Showcase is an engaging feature to have on the homepage. It makes the site feel more dynamic and interactive, and it showcases the scope of what’s possible with SplashKit from visuals to gameplay mechanics.
