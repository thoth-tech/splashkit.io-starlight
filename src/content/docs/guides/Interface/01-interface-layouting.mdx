...
<TabItem label="Top-level Statements">
 ...
 ```csharp
    ...
    while (!QuitRequested())
    {
        ...
        // Draw interface, then refresh screen
        DrawInterface();
        RefreshScreen();
    }
...
<TabItem label="Object-Oriented">
 ...
 ```csharp
    ...
    namespace LayoutUserInterfaces
    {
...
<TabItem label="Top-level Statements">
 ...
 ```csharp
    ...
    // Setup a variable to store the user's string
...
<TabItem label="Top-level Statements">
 ...
 ```csharp
    // Check for header and get user input
    if (Header("Edit Message!"))
    {
        userMessage = TextBox(userMessage);
    }
...
<TabItem label="Top-level Statements">
 ...
 ```csharp
    // Display text outside the inset area
    Paragraph("This text is outside the inset area!");

    // Start inset area
    StartInset("Inset area", 60);
        if (Button("Button 1!")) WriteLine("Button 1 clicked!");
        if (Button("Button 2!")) WriteLine("Button 2 clicked!");
        if (Button("Button 3!")) WriteLine("Button 3 clicked!");
        if (Button("Button 4!")) WriteLine("Button 4 clicked!");
        if (Button("Button 5!")) WriteLine("Button 5 clicked!");
        if (Button("Button 6!")) WriteLine("Button 6 clicked!");
    EndInset("Inset area");
 ```
...
<TabItem label="Object-Oriented">
 ...
 ```csharp
    ...
    SplashKit.StartInset("Inset area", 60);
        if (SplashKit.Button("Button 1!")) SplashKit.WriteLine("Button 1 clicked!");
        if (SplashKit.Button("Button 2!")) SplashKit.WriteLine("Button 2 clicked!");
        if (SplashKit.Button("Button 3!")) SplashKit.WriteLine("Button 3 clicked!");
        if (SplashKit.Button("Button 4!")) SplashKit.WriteLine("Button 4 clicked!");
        if (SplashKit.Button("Button 5!")) SplashKit.WriteLine("Button 5 clicked!");
        if (SplashKit.Button("Button 6!")) SplashKit.WriteLine("Button 6 clicked!");
...
<TabItem label="Top-level Statements">
 ...
 ```csharp
    ...
    // Start second tree node
    if (StartTreeNode("Some more buttons!"))
    {
        if (Button("Button 4!")) WriteLine("Button 4 clicked!");
        if (Button("Button 5!")) WriteLine("Button 5 clicked!");

        // Start nested tree node
...
<TabItem label="Top-level Statements">
 ...
 ```csharp
    ...
    SplitIntoColumns(3);
        ...
        // Reset layout height to default
        SetLayoutHeight(0);
        if (Button("Button 4!")) WriteLine("Button 4 clicked!");
        if (Button("Button 5!")) WriteLine("Button 5 clicked!");
        if (Button("Button 6!")) WriteLine("Button 6 clicked!");
...
<TabItem label="Top-level Statements">
 ...
 ```csharp
    ...
    SplitIntoColumns(2);
        ...
        // Enter second column
        EnterColumn();
            SetLayoutHeight(0); // Reset to default
            if (Button("Button 4!")) WriteLine("Button 4 clicked!");
            if (Button("Button 5!")) WriteLine("Button 5 clicked!");
            if (Button("Button 6!")) WriteLine("Button 6 clicked!");
        LeaveColumn();
...
<TabItem label="Object-Oriented">
 ...
 ```csharp
    ...
    SplashKit.SplitIntoColumns(2);
        ...
        // Enter second column
        SplashKit.EnterColumn();
            SplashKit.SetLayoutHeight(0); // Reset to default
            if (SplashKit.Button("Button 4!")) SplashKit.WriteLine("Button 4 clicked!");
            if (SplashKit.Button("Button 5!")) SplashKit.WriteLine("Button 5 clicked!");
            if (SplashKit.Button("Button 6!")) SplashKit.WriteLine("Button 6 clicked!");
        SplashKit.LeaveColumn();
