...
description: SplashKit resource bundles allow you to quickly and easily load anumber of resources in the `Resources` folder.
---

:::tip[Resource Bundles]
SplashKit resource bundles allow you to quickly and easily load a
...
<Accordion title="See Implementations in Guides" uniqueID={"load_resource_bundle_guides"} customButton="guidesAccordion">

<ul><li> [Using Animations in SplashKit](/guides/animations/0-using-animations/) </li></ul>
