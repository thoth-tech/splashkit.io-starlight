...
- [Scenario: Calculating Ship Trajectory](#scenario-calculating-ship-trajectory)
...
<Tabs syncKey="code-language">
  ...
  <TabItem label="C#">
  ```csharp 
  Vector2D v1 = new Vector2D() { X = 100, Y = 50 };
  Vector2D v2 = new Vector2D() { X = 200, Y = 150 };
  Vector2D result = SplashKit.VectorAdd(v1, v2);
  ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="code-language">
  ...
  <TabItem label="C#">
  ```csharp 
  Vector2D v1 = new Vector2D() { X = 300, Y = 200 };
  Vector2D v2 = new Vector2D() { X = 100, Y = 50 };
  Vector2D result = SplashKit.VectorSubtract(v1, v2);
  ```
  </TabItem>
</Tabs>
