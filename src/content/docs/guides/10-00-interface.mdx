...
1. Let's begin by setting up our main function and opening up a window for us to place our interface elements on. See [Drawing using Procedures](/guides/01-00-drawing/) if you aren't familiar with this part. In this example code, we've:
...
<img alt="A single button on a white window" src="/images/articles/interface/first_button.png" class="centered_img"/>
...
<img alt="Clicking the button, it now responds when hovered and clicked." src="/images/articles/interface/clicking_button.gif" class="centered_img" />
...
<img alt="Clicking the button - on click, the text 'The button was clicked!' is printed in the terminal" src="/images/articles/interface/clicking_button_write_terminal.gif" class="centered_img" />
...
<img alt="A button and a text box. When the button is clicked, the contents of the text box is printed in the terminal." src="/images/articles/interface/text_box_to_terminal.gif" class="centered_img" />
...
<img alt="A button, text box, and slider. Adjusting the value of the slider changes the width of the other controls." src="/images/articles/interface/slider.gif" class="centered_img" />
