...
namespace SpriteBitmapCollisionDemo
{
    public class Program
    {
        public static void Main()
        {
            ...
            if (SplashKit.SpriteBitmapCollision(skSprite, fileBmp, 20, fileBmpLoc.X, fileBmpLoc.Y))
                SplashKit.WriteLine("SplashKit got a new file!");

            if (SplashKit.SpriteBitmapCollision(skSprite, fileBmp, 200, bugBmpLoc.X, bugBmpLoc.Y))
