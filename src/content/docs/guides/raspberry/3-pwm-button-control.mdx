...
See [Blink LED Tutorial](/guides/raspberry/0-blink-led/#components) for more details on these components.
...
See [Read Button Press Tutorial](/guides/raspberry/1-read-button-press/#components) for more details on these components:
