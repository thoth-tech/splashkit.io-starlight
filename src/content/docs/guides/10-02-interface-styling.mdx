...
<table>
    <tr>
        <td width="50%">
            <img alt="Several controls shown in a panel with the shaded dark style preset." class="centered_img" src="/images/articles/interface/styles/shadeddark.png" />
        </td>
        <td>
            <img alt="Several controls shown in a panel with the flat dark style preset" class="centered_img" src="/images/articles/interface/styles/flatdark.png" />
        </td>
    </tr>
    <tr>
        <td width="50%">
    ...
    <tr>
        <td>
            <img alt="Several controls shown in a panel with the shaded light style preset" class="centered_img" src="/images/articles/interface/styles/shadedlight.png" />
        </td>
        <td>
            <img alt="Several controls shown in a panel with the flat light style preset" class="centered_img" src="/images/articles/interface/styles/flatlight.png" />
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <img alt="Several controls shown in a panel with the bubble style preset" class="centered_img" src="/images/articles/interface/styles/bubble.png" />
        </td>
        <td>
            <img alt="Several controls shown in a panel with the bubble multi-coloured style preset" class="centered_img"src="/images/articles/interface/styles/bubble_multicolored.png" />
        </td>
    </tr>
    <tr>
        <td>
...
<table>
    <tr>
        <td>
            <img alt="Several controls shown in a panel with the shaded dark style preset, tinted slightly blue" class="centered_img" src="/images/articles/interface/styles/shadeddark_colored.png" />
        </td>
        <td>
            <img alt="Several controls shown in a panel with the shaded light style preset, tinted slightly blue" class="centered_img" src="/images/articles/interface/styles/shadedlight_colored.png" />
        </td>
        <td>
            <img alt="Several controls shown in a panel with the bubble style preset, tinted slightly blue" class="centered_img" src="/images/articles/interface/styles/bubble_colored.png" />
        </td>
    </tr>
</table>
...
You can also create your own unique look with the other interface style functions. The main two to try first are:
 ...
 - [Set Interface Shadows](/api/interface/#set-interface-shadows), changes the color of and how blurry shadows are (see below)
    <img alt="A gif demonstrating adjusting the blur and color of shadows in the interface." class="centered_img" src="/images/articles/interface/shadow_settings.gif" />
...
<img alt="An image of the style panel - a set of many controls that allow adjusting the interface's style." class="centered_img" src="/images/articles/interface/style_panel.png" />
...
By default, the interface will try and use a font available in your system. You can also set the font yourself, to customize how text appears!
 ...
 - [Set Interface Font Size](/api/interface/#set-interface-size), lets you change the current font size
