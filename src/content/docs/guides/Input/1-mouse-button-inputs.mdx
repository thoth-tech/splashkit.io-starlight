...
Here are some functions that are used to handle mouse button inputs. All these functions use SplashKit's [Mouse Button](/api/input/#mouse-button) data type for the argument and check if the specified button has been clicked, held down, or released.
...
namespace MouseInputs
{
    public class Program
    {
        ...
        {
            MouseInputApp app = new MouseInputApp();
            app.Run();
        }
    }

    public class MouseInputApp
    {
        private Window _window;  

        public MouseInputApp()
        {
             _window = SplashKit.OpenWindow("Mouse Inputs", 800, 600);
        }

        public void Run()
        {
            
            while (!SplashKit.WindowCloseRequested(_window))
            {
...
namespace MouseMovementApp
{
    public class Program
    {
        public static void Main()
        {
            MouseMovementApp app = new MouseMovementApp();
            app.Run();
        }
    }

    public class MouseMovementApp
    {
        private Window _window; 
        private double _hue = 0.8; 
        private double _saturation = 0.8; 
        private double _brightness = 0.8; 
        private Vector2D _movement; 
        public MouseMovementApp()
        {
             _window = SplashKit.OpenWindow("Mouse Movement", 800, 600);
        }
        ...
        public void Run()
        {
            ...
            {
                SplashKit.ProcessEvents();  
                _movement = SplashKit.MouseMovement(); 
                
                HandleMouseInput();
                SplashKit.ClearScreen(SplashKit.HSBColor(_hue, _saturation, _brightness));
        ...
        private void HandleMouseInput()
        {
            ...
            if (SplashKit.MouseDown(MouseButton.LeftButton))
            {
                _hue += _movement.X / SplashKit.ScreenWidth();
            }

            
            if (SplashKit.MouseDown(MouseButton.RightButton))
            {
                _saturation += _movement.Y / SplashKit.ScreenHeight();
            }
        }
    }
}
...
namespace MouseScrollingApp
{
    public class Program
    {
        public static void Main()
        {
            MouseScrollApp app = new MouseScrollApp();
            app.Run();
        }
    }

    public class MouseScrollApp
    {
        private Window _window; 
        private double _hue = 0.6; 
        private double _saturation = 0.6; 
        private double _brightness = 0.6; 
        private Vector2D _scroll; 

        public MouseScrollApp()
        {
            _window = SplashKit.OpenWindow("Mouse Scrolling", 800, 600);
        }
        ...
        public void Run()
        {
            ...
            {
                SplashKit.ProcessEvents();  
                _scroll = SplashKit.MouseWheelScroll(); 
...
namespace MouseLocationApp
{
    public class Program
    {
        public static void Main()
        {
            MouseLocationApp app = new MouseLocationApp();
            app.Run();
        }
    }

    public class MouseLocationApp
    {
        private Window _window;  

        public MouseLocationApp()
        {
           _window = SplashKit.OpenWindow("Mouse Location", 800, 600);
        }
...
namespace MouseLocationApp
{
    public class Program
    {
        public static void Main()
        {
            MouseCurtainApp app = new MouseCurtainApp();
            app.Run();
        }
    }

    public class MouseCurtainApp
    {
        private Window _window; 
        private float _x = 0; 

        public MouseCurtainApp()
        {
             _window = SplashKit.OpenWindow("Mouse Location", 800, 600);
        }
        ...
        private void DrawScene()
        {
            ...
            SplashKit.FillCircle(SplashKit.ColorBlue(), 400, 300, 100);
             ...
             SplashKit.FillRectangle(SplashKit.ColorPurple(), 0, 0, _x, SplashKit.ScreenHeight());
        }
    }
}
```
...
namespace MouseLocationApp
{
    ...
    public class MouseCurtainApp
    {
        ...
        private void DrawScene()
        {
            ...
            SplashKit.FillRectangle(SplashKit.ColorPurple(), 0, 0, SplashKit.ScreenWidth(), _y);
        }
    }
}
```
...
namespace MouseVisibilityApp
{
    public class Program
    {
        public static void Main()
        {
             MouseVisibilityApp app = new MouseVisibilityApp();
            app.Run();
        }
    }

    public class MouseVisibilityApp
    {
        private Window _window; 
        private Circle _blackHole; 

        public MouseVisibilityApp()
        {
            _window = SplashKit.OpenWindow("Mouse Visibility", 800, 600);

           _blackHole = SplashKit.CircleAt(SplashKit.ScreenCenter(), 50);
        }
        ...
        private void UpdateMouseVisibility()
        {
            ...
            if (SplashKit.PointInCircle(SplashKit.MousePosition(), _blackHole))
            {
                SplashKit.HideMouse();
            }
        ...
        private void DrawScene()
        {
            ...
            SplashKit.FillCircle(SplashKit.ColorBlack(), _blackHole);
...
namespace SpotlightApp
{
    ...
    public class SpotlightApp
    {
        private Window _window; 
        private Circle _spotLight; 
        public SpotlightApp()
        {
           _window = SplashKit.OpenWindow("Mouse Visibility", 800, 600);

           _spotLight = SplashKit.CircleAt(SplashKit.ScreenCenter(), 100);
        }
        ...
        private void UpdateMouseVisibility()
        {
            ...
            bool isMouseInSpotLight = SplashKit.PointInCircle(SplashKit.MousePosition(), _spotLight);
        ...
        private void DrawScene()
        {
           ...
           SplashKit.FillCircle(SplashKit.ColorWhite(), _spotLight);
        }
    }
}
```
