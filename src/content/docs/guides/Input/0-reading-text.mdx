...
This article shows you how to start reading text from the user. It includes reading text from the command line but also how to read text from within a graphical application.
...
<TabItem label="C++">
  ...
  int main()
  {
      ...
      write_line(quest); // output quest to the terminal
...
<TabItem label="C#">
  ...
  WriteLine(quest); // output quest to the terminal
  ```
