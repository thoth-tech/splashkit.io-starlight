...
# Function used here ↓
vertical_rectangle = bitmap_bounding_rectangle(vertical_bitmap)
horizontal_rectangle = bitmap_bounding_rectangle(horizontal_bitmap)
...
draw_rectangle_record(color_black(), vertical_rectangle)
draw_bitmap(horizontal_bitmap, 450, 400)
draw_rectangle_record(color_black(), horizontal_rectangle)
refresh_screen()
