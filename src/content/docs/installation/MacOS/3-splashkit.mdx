...
1. **Run the SplashKit Installer**
   ...
   If you want to use fingerprint authentication when the installation needs elevated permissions, rather than typing your password each time, run the following command in your terminal _(**before running the command above**)_:
...
2. **Verify the Installation**
   ...
   _Tip:_ Use `skm help` to explore additional commands for managing SplashKit.
