...
import GameCardSwiper from "../../components/react/GameCardSwiper/index.jsx";

## Games Showcase

Discover what's possible with SplashKit! Check out these amazing games created by our community:

<GameCardSwiper client:load />

<center>
  <a href="/games/" style="display: inline-block; margin-top: 1rem; padding: 0.75rem 2rem; background-color: var(--sl-color-accent); color: white; text-decoration: none; border-radius: 0.5rem; font-weight: bold; font-size: 1.1rem; transition: all 0.3s ease; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    View All Games
  </a>
</center>
