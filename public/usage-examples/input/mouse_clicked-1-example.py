...
while not quit_requested():
    ...
    if mouse_clicked(LEFT_BUTTON):
        ...
        if point_in_circle(mouse_point, circle_at(180, 250, 60)):
            clicked_circle = "Red"
            click_count += 1
        elif point_in_circle(mouse_point, circle_at(400, 250, 60)):
            clicked_circle = "Blue"
            click_count += 1
        elif point_in_circle(mouse_point, circle_at(620, 250, 60)):
    ...
    draw_text("Total clicks: " + str(click_count), COLOR_BLACK, 20, 100)
