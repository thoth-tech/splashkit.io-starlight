...
play_pause = create_bitmap("play_pause", 75, 100)
...
while not quit_requested():
    ...
    if mouse_clicked(MouseButton.left_button) and point_in_rectangle(mouse_position(), rectangle_from(250, 275, 125, 100)):
    ...
    if mouse_clicked(MouseButton.left_button) and point_in_rectangle(mouse_position(), rectangle_from(125, 275, 75, 100)):
