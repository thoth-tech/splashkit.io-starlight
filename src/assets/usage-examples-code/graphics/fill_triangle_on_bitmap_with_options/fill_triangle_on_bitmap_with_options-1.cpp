...
int main()
{
    ...
    open_window("Fill Triangle On Bitmap With Options Example", 800, 600);
    ...
    fill_triangle_on_bitmap_with_options(my_bitmap, COLOR_RED, scaled_x1, scaled_y1, scaled_x2, scaled_y2, scaled_x3, scaled_y3, opts);
