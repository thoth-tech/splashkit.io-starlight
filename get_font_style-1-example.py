...
# Load font
font_name = "Arial"
my_font = load_font(font_name, "Arial.TTF")
...
while not quit_requested():
    ...
    if key_typed(KeyCode.n_key):
        ...
        message = f"Font style set to {get_font_style_name_as_string(font_name)}. Press B for Bold, I for Italics, or U for Underlined."
    elif key_typed(KeyCode.b_key):
        set_font_style(my_font, FontStyle.bold_font)
        message = f"Font style set to {get_font_style_name_as_string(font_name)}. Press N for Normal, I for Italics, or U for Underlined."
    elif key_typed(KeyCode.i_key):
        set_font_style(my_font, FontStyle.italic_font)
        message = f"Font style set to {get_font_style_name_as_string(font_name)}. Press N for Normal, B for Bold, or U for Underlined."
    elif key_typed(KeyCode.u_key):
        set_font_style(my_font, FontStyle.underline_font)
        message = f"Font style set to {get_font_style_name_as_string(font_name)}. Press N for Normal, B for Bold, or I for Italics."
